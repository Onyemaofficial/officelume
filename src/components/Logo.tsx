...
/** OfficeLume mark: a lamp/beam glyph over a navy tile, plus the wordmark. */
export function Logo({ tagline = false, inverse = false }: LogoProps) {
  return (
    <span className={inverse ? 'logo logo-inverse' : 'logo'}>
      <svg className="logo-mark" viewBox="0 0 64 64" role="img" aria-label="OfficeLume logo" focusable="false">
